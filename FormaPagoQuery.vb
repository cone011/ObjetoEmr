...
Public Class FormaPagoQuery
    ...
    Public ReadOnly Property GetAll() As String 
        Get
            ...
            Try
                Resultado = "SELECT * FROM FormaPago"
            Catch 
                Throw
            End Try
            Return Resultado
    ...
    Public ReadOnly Property GetObjectById() As String 
        Get
            Dim Resultado As String = String.Empty
            Try
                Resultado = "SELECT * FROM FormaPago WHERE idFormaPago = @idFormaPago"
            Catch
                Throw
            End Try
            Return Resultado
    ...
    Public ReadOnly Property SaveFormaPago() As String 
        Get
            ...
            Try
                If isNew Then
                    Resultado = "INSERT INTO FormaPago
                                                      (
                                                          CodigoFormaPago,
                                                ...
                                                VALUES(
                                                    ...
                                                    "                          
                Else 
                    Resultado = "UPDATE FormaPago SET CodigoFormaPago = @CodigoFormaPago,
