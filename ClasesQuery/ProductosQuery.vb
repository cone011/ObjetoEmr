...
Public Class ProductosQuery
    ...
    Public ReadOnly Property GetAllFacturacion() As String
        Get
            Dim resultado As String = String.Empty
            Try
                resultado = "SELECT codpro, descri, punit, idreg, pcosto FROM producto"
            Catch
                Throw
            End Try
            Return resultado
    ...
    Public ReadOnly Property SaveProducto() As String
        Get
            ...
            Try
                If isNew Then
                    resultado = "INSERT INTO prodcuto(codpro,descri,punit,pcosto,ivaprocent,exist1) VALUES(@CodigoProducto,@DescripcionProducto,@PrecioUnitario,@PrecioCosto, @IvaProcentajeProducto,@ExistenciaProducto)"
                Else
                    resultado = "UPDATE producto SET codpro = @CodigoProducto, descri = @DescripcionProducto, punit  = @PrecioUnitario, pcosto = @PrecioCosto, ivaprocent = @IvaProcentajeProducto,exis1 = @ExistenciaProducto where idreg = @idProducto"
                End If
